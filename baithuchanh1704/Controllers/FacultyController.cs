...
namespace baithuchanh1704.Controllers
{
    public class FacultyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FacultyID,FullName")] Faculty faculty)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("FacultyID,FullName")] Faculty faculty)
        {
